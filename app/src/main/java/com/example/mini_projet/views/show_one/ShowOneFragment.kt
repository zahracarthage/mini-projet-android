package com.example.mini_projet.views.show_one
...
class ShowOneFragment : Fragment() {
    ...
    override fun onStart() {
        ...
        Picasso.with(context).load(ApiClient.BASE_URL + restaurant.image).into(image)

        abtText.text = restaurant.title
        aboutDescription.text = restaurant.description
